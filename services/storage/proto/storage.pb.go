...
const file_proto_storage_proto_rawDesc = "" +
	...
	"\x0fclinic_schedule\x18\x01 \x03(\v2\x1d.storage.WeeklyClinicScheduleR\x0eclinicSchedule2\xee\x04\n" +
	...
	"\n" +
	"AddPatient\x12\x1a.storage.AddPatientRequest\x1a\x1b.storage.AddPatientResponse\x12Z\n" +
	"\x17GetClinicWeeklySchedule\x12\x15.storage.EmptyRequest\x1a(.storage.GetClinicWeeklyScheduleResponse\x12h\n" +
	"\x17GetDoctorWeeklySchedule\x12%.storage.GetScheduleByDoctorIdRequest\x1a&.storage.GetScheduleByDoctorIdResponseB\x19Z\x17storage/proto;storagepbb\x06proto3"
...
var file_proto_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
...
var file_proto_storage_proto_depIdxs = []int32{
	24, // 0: storage.AddPatientRequest.birth_date:type_name -> google.protobuf.Timestamp
	9,  // 1: storage.GetAllSpecsResponse.specs:type_name -> storage.Specialization
	24, // 2: storage.WeeklyDoctorSchedule.start_time:type_name -> google.protobuf.Timestamp
	24, // 3: storage.WeeklyDoctorSchedule.end_time:type_name -> google.protobuf.Timestamp
	...
	24, // 6: storage.WeeklyClinicSchedule.start_time:type_name -> google.protobuf.Timestamp
	24, // 7: storage.WeeklyClinicSchedule.end_time:type_name -> google.protobuf.Timestamp
	...
	14, // 16: storage.StorageService.GetDoctorWeeklySchedule:input_type -> storage.GetScheduleByDoctorIdRequest
	...
	23, // 23: storage.StorageService.GetClinicWeeklySchedule:output_type -> storage.GetClinicWeeklyScheduleResponse
	15, // 24: storage.StorageService.GetDoctorWeeklySchedule:output_type -> storage.GetScheduleByDoctorIdResponse
